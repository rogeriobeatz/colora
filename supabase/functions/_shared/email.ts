...
import { EMAIL_CONFIG, EMAIL_URLS } from "./domains.ts";
...
export const sendWelcomeEmail = async (data: WelcomeEmailData): Promise<boolean> => {
  try {
          ...
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center;">
                <a href="${EMAIL_URLS.DASHBOARD}" class="button">Acessar Meu Painel</a>
              </div>
    ...
    const { data: result, error } = await resend.emails.send({
      from: EMAIL_CONFIG.FROM.NO_REPLY,
      to: [data.email],
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div style="text-align: center;">
                <a href="${EMAIL_URLS.SIMULATOR}" class="button">Começar a Simular</a>
              </div>
